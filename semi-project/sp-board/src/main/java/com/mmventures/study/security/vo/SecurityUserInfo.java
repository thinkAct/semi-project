...
//
//	private SecurityUserInfo() { }
//	
//	private SecurityUserInfo(final String authenticationUsername,final String authenticationPassword, 
//			final boolean accountEnable,final Collection <? extends GrantedAuthority> userAuthorities) { 
//		this.username = authenticationUsername;
//		this.password = authenticationPassword;
//		this.enabled = accountEnable;
